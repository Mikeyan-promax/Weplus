...
| 日期 | 更新内容 |
|------|----------|
| 2025-Q1 | 数据库从 SQLite 迁移至 PostgreSQL + pgvector |
| 2025-Q1 | 向量存储从 ChromaDB + FAISS 迁移至 pgvector |
| 2025-Q1 | 重构 Docker 部署为单容器架构（Nginx + Supervisord + Uvicorn） |
| 2025-Q1 | 集成 Railway 云部署支持 |
| 2025-Q1 | 全面重构项目文档，合并为结构化文档体系 |
| 2025-Q1 | 新增 Sentry 错误追踪与 Prometheus 监控 |
...
- **多轮对话**：上下文记忆，连续问答
<img width="3030" height="1918" alt="屏幕截图 2025-11-08 145922" src="https://github.com/user-attachments/assets/2fd64143-5c65-4b97-9b99-599a36e44c60" />
